    ...
    >
        ...
        lg:items-stretch">
            <div className=" mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                Get in touch to discuss your project ideas, and let's work together to bring something incredible to life!
                </p>
            ...
            <form 
                action="https://getform.io/f/arooojnb" 
                method="POST"
                className="xl:pl-10 2xl:pl-20"
            >
                <div className="md:grid md:items-center
                md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            autoComplete="name"
                            required
                            placeholder="sandun Dissanayake" 
                    ...
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            autoComplete="email"
                            required
                            placeholder="sandundissanayaka05@gamil.com" 
                            className="text-field reveal-up" 
                        />
                    </div>
                </div>
